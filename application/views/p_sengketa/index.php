...
<!-- Page Heading -->
                            ...
                            <tbody>
                                <tr class="text-center">
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= base_url('p_sengketa/delete/' . $admin->no) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda ingin hapus data ini ?')"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                            </tbody>
                            <?php endforeach ?>
       ...
       <!-- Button trigger modal -->
         ...
         <!-- Modal -->
        <?php foreach ($sengketa as $admin): $no++;?> 
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            <form action="<?= base_url('p_sengketa/edit/'. $admin->no) ?>" method="post" enctype="multipart/form-data">
