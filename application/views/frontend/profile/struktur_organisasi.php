                ...
                <div class="left-side">
                    <div class="item-holder">
                        <div class="content-text pt-4">
							...
							<p>Dalam rangka mewujudkan manajemen pengelolaan Perguruan Tinggi dan meningkatkan&nbsp; efektifitas kebijakan pembinaan PT di lingkungan LLDIKTI Wilayah V maka dibentuklah Struktur Sistem kerja yang meliputi :&nbsp;</p>
							<p><img alt="" src="<?= base_url('assets/img/strukturorganisasilldikti.png') ?>" style="width:80%; margin: 50px 0px; text-align: center;" /></a></p>
                        </div>
                    </div>
                </div>
            </div>
