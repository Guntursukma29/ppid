   ...
   <section class="blog-section mt-2">
    <div class="container">
		<div class="block mt-3" style="text-align: center;">
            <h3>DAFTAR INFORMASI PUBLIK BERKALA</h3>
        </div>
        <br>
        <div class="row">
				...
				<div class='row'>
					<div class='col-md-12'>
						...
						<div class='regulasi col-md-12 mt-3' >
							...
							<ul style="margin: 20px;">
								<li><a href="">1. Agenda penting Lembaga Layanan Pendidikan Tinggi Wilayah V tahun 2021</a></li>
								<li><a href="">2. lnformasi tentang penerimaan calon aparatur sipil negara di lingkungan Kemdikbudristek</a></li>
								<li><a href="">3. Rencana Strategis (Renstra) Lembaga Layanan Pendidikan Tinggi Wilayah V</a></li>
                                <li><a href="">4. PAGU APBN Lembaga Layanan Pendidikan Tinggi Wilayah V</a></li>
                                <li><a href="">5. DIPA dan RKAKL</a></li>
                                <li><a href="">6. Laporan akuntabilitas kinerja Lembaga Layanan Pendidikan Tinggi Wilayah V</a></li>
                                <li><a href="">7. Ringkasan laporan Keuangan </a></li>
