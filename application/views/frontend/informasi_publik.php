<div class="container mb-5" style="margin-top: 190px; background: rgba(52, 83, 165, 1);">
    <div class="row mt-5 d-flex flex-row align-items-center">
        <div class="col-md-6 float-left" style="padding-left:40px;">
            <h1 class="text-bold text-white   " >DAFTAR INFORMASI PUBLIK BERKALA</h1>
        </div>
        <div class="col-md-6 float-right">
            <img src="<?= base_url('assets/img/img1.png') ?>" class="img-fluid" style="width: 400px;">
        </div>
    </div>
</div>
...
<div class="container mb-5" style="background: rgba(52, 83, 165, 1);">
    <div class="row mt-5 d-flex flex-row align-items-center">
        <div class="col-md-6 float-left" style="padding-left:40px;">
            <h1 class="text-bold text-white   " >DAFTAR INFORMASI PUBLIK SERTA MERTA</h1>
        </div>
        <div class="col-md-6 float-right">
            <img src="<?= base_url('assets/img/img1.png') ?>" class="img-fluid" style="width: 400px;">
        </div>
...
<div class="container mb-5" style="background: rgba(52, 83, 165, 1);">
    <div class="row mt-5 d-flex flex-row align-items-center">
        <div class="col-md-6 float-left" style="padding-left:40px;">
            <h1 class="text-bold text-white   " >DAFTAR INFORMASI PUBLIK SETIAP SAAT</h1>
        </div>
        <div class="col-md-6 float-right">
            <img src="<?= base_url('assets/img/img1.png') ?>" class="img-fluid" style="width: 400px;">
        </div>
...
<div class="container mb-5" style="background: rgba(52, 83, 165, 1);">
    <div class="row mt-5 d-flex flex-row align-items-center">
        <div class="col-md-6 float-left" style="padding-left:40px;">
            <h1 class="text-bold text-white   " >DAFTAR INFORMASI PUBLIK DIKECUALIKAN</h1>
        </div>
        <div class="col-md-6 float-right">
            <img src="<?= base_url('assets/img/img1.png') ?>" class="img-fluid" style="width: 400px;">
        </div>
