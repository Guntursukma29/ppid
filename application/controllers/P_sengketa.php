...
class P_sengketa extends CI_Controller 
{
    ...
    {
        $data['sengketa'] = $this->informasi_model->get_data('tbl_sengketa')->result();
        ...
        $this->load->view('p_sengketa/index', $data);
    ...
    public function tambah()
    {
        ...
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('p_sengketa/tambah');
        $this->load->view('templates/footer');
    }
...
// exit();
            ...
            $this->informasi_model->insert_data($data, 'tbl_sengketa');
    ...
    public function edit($no)
    {
        ...
        //     $row = $this->admin_model->getdata_by_id('tbl_artikel', $id)->row();
            ...
            $this->informasi_model->update_data($data,'tbl_sengketa');
    ...
    public function delete($id){
        $where = array('no' => $id);
        $this->informasi_model->delete($where, 'tbl_sengketa');
        $this->session->set_flashdata('message', '<div class="alert alert-success alert-dismissible fade show" role="alert">
