<!-- <?php foreach ($admin as $admin):?>
    <div class="container-fluid">
        <form action="<?= base_url('admin/tambah_aksi'); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label>Waktu</label>
                <input type="date" name="Waktu" class="form-control" value="<?= $admin->Waktu ?>">
            ...
            <div class="form-group">
                <label>Gambar</label>
                <input type="file" name="Gambar" class="form-control" size="20" value="<?= $admin->Gambar ?>" accept=".png,.jpg,.jpeg,.pdf">
                <?= form_error('Gambar', '<div class="text-small text-danger">', '</div>' ) ?>
            </div>
            <div class="form-group">
                <label>Deskripsi</label>
                <textarea id="Deskripsi" type="text" name="Deskripsi" class="form-control" value="<?= $admin->Deskripsi ?>"></textarea>
