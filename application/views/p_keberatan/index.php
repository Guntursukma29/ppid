...
<!-- Page Heading -->
            ...
            <div class="card shadow mb-3">
                <div class="card-header py-3">
                    <a href="<?= base_url('p_sengketa/tambah') ?>" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i><?= $title; ?></a>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                <tr class="text-center">
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= base_url('p_keberatan/delete/' . $admin->no) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda ingin hapus data ini ?')"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                            </tbody>
                            <?php endforeach ?>
       ...
       <!-- Button trigger modal -->
         ...
         <!-- Modal -->
        <?php foreach ($keberatan as $admin): $no++;?> 
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            <form action="<?= base_url('p_keberatan/edit/'. $admin->no) ?>" method="post" enctype="multipart/form-data">
